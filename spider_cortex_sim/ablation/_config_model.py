...
class BrainAblationConfig:
    ...
    def to_summary(self) -> dict[str, object]:
        from ._config_summary import brain_ablation_config_to_summary

        return brain_ablation_config_to_summary(self)

    @classmethod
    def from_summary(cls, summary: Mapping[str, object]) -> "BrainAblationConfig":
        from ._config_summary import brain_ablation_config_from_summary

        return brain_ablation_config_from_summary(cls, summary)
