...
DIRECT_LOCAL_BRANCHES_DIAGNOSTIC_VARIANT_SPECS: tuple[DirectPolicyDiagnosticVariantSpec, ...] = (
    ...
    direct_policy_diagnostic_variant(
        'true_monolithic_option_affordance_position_phase_option_dynamics_separate_action_backbone_geodesic_inputs_post_rest_probe_replayable_teacher_distill_option_replay_policy',
        direct_policy_recurrent=True,
...
def diagnostic_direct_local_branches_configs(profile_fields: dict[str, object]) -> Dict[str, BrainAblationConfig]:
    return build_direct_policy_diagnostic_configs(DIRECT_LOCAL_BRANCHES_DIAGNOSTIC_VARIANT_SPECS, profile_fields)
