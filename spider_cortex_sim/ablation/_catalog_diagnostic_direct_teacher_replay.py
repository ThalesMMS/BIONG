...
DIRECT_TEACHER_REPLAY_DIAGNOSTIC_VARIANT_SPECS: tuple[DirectPolicyDiagnosticVariantSpec, ...] = (
    direct_policy_diagnostic_variant(
        'true_monolithic_option_affordance_position_teacher_option_replay_policy',
    ...
    direct_policy_diagnostic_variant(
        'true_monolithic_option_affordance_position_phase_option_feedback_teacher_option_replay_policy',
        direct_policy_recurrent=True,
        direct_policy_phase_head=True,
    ...
    direct_policy_diagnostic_variant(
        'true_monolithic_option_affordance_position_phase_option_cooldown_teacher_option_replay_policy',
        direct_policy_recurrent=True,
        direct_policy_phase_head=True,
        direct_policy_event_attention=True,
        direct_policy_event_buffer_size=8,
    ...
    direct_policy_diagnostic_variant(
        'true_monolithic_option_affordance_position_phase_option_action_teacher_option_replay_policy',
        direct_policy_recurrent=True,
        direct_policy_phase_head=True,
        direct_policy_event_attention=True,
        direct_policy_event_buffer_size=8,
    ...
    direct_policy_diagnostic_variant(
        'true_monolithic_option_affordance_position_phase_option_dynamics_sequence_teacher_option_replay_policy',
        direct_policy_recurrent=True,
        direct_policy_phase_head=True,
        direct_policy_event_attention=True,
        direct_policy_event_buffer_size=8,
    ...
    direct_policy_diagnostic_variant(
        'true_monolithic_option_affordance_position_phase_option_dynamics_decoder_recurrent_action_transition_teacher_option_replay_policy',
        direct_policy_recurrent=True,
        direct_policy_phase_head=True,
        direct_policy_event_attention=True,
        direct_policy_event_buffer_size=8,
    ...
    direct_policy_diagnostic_variant(
        'true_monolithic_option_affordance_position_phase_option_dynamics_decoder_recurrent_action_core_teacher_option_replay_policy',
        direct_policy_recurrent=True,
        direct_policy_phase_head=True,
        direct_policy_event_attention=True,
        direct_policy_event_buffer_size=8,
    ...
    direct_policy_diagnostic_variant(
        'true_monolithic_option_affordance_position_phase_option_dynamics_separate_action_backbone_teacher_option_replay_policy',
        direct_policy_recurrent=True,
        direct_policy_phase_head=True,
        direct_policy_event_attention=True,
        direct_policy_event_buffer_size=8,
...
def diagnostic_direct_teacher_replay_configs(profile_fields: dict[str, object]) -> Dict[str, BrainAblationConfig]:
    return build_direct_policy_diagnostic_configs(DIRECT_TEACHER_REPLAY_DIAGNOSTIC_VARIANT_SPECS, profile_fields)
