        ...
        self.assertEqual(
            ...
            "\n".join(
                [
                    ...
                    "| [Variant assumptions](#variant-assumptions-confound-control-metadata) | n/a | Confound-control metadata and access notes. |",
                    "| [Architecture Capacity](#architecture-capacity) | missing | Model parameter counts and capacity comparison tables. |",
                    "| [Capacity Sweep](#capacity-sweep) | n/a | Sweep results and interpretation table (if present). |",
                    "| [Primary Benchmark](#primary-benchmark) | n/a | Single-run benchmark-of-record metric row (if present). |",
                    "| [Benchmark-of-Record Summary](#benchmark-of-record-summary) | n/a | Aggregate benchmark tables with uncertainty (if present). |",
                    "| [Claim Test Results with Uncertainty](#claim-test-results-with-uncertainty) | n/a | Claim tests + uncertainty (if present). |",
                    "| [Effect Sizes Against Baselines](#effect-sizes-against-baselines) | n/a | Effect sizes against baselines (if present). |",
                    "| [Architectural Ladder Comparison](#architectural-ladder-comparison) | n/a | Pairwise ladder comparisons and rung descriptions. |",
                    "| [Cross-Profile Ladder Comparison](#cross-profile-ladder-comparison) | n/a | Cross-profile ladder summary + shaping gaps. |",
                    "| [Unified Architectural Ladder Report](#unified-architectural-ladder-report) | n/a | Unified ladder analysis with detailed subsections. |",
                    "| [Shaping Minimization Program](#shaping-minimization-program) | n/a | Reward shaping audit tables and interpretation. |",
                    ...
                    "| Generated Files | available | List of artifact files written alongside the report. |",
                    "",
                    "",
                    "## Table of contents",
                    "",
